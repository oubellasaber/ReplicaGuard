            ...
            modelBuilder.Entity("ReplicaGuard.Core.HosterAccounts.Secret", b =>
                {
                    ...
                    b.OwnsOne("ReplicaGuard.Core.HosterAccounts.SecretValue", "Value", b1 =>
                        {
                            b1.Property<Guid>("SecretId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");

                            b1.Property<byte[]>("CipherBytes")
                                .IsRequired()
                                .HasColumnType("bytea")
                            ...
                            b1.ToTable("secrets", "replicaguard");

                            b1.WithOwner()
                                .HasForeignKey("SecretId")
                                .HasConstraintName("fk_secrets_secrets_id");
                        });
