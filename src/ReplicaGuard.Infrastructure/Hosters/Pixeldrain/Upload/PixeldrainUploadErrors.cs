...
internal static class PixeldrainUploadErrors
{
    ...
    public static Error FileTooLarge() =>
        new Error("Hoster.Pixeldrain.Upload.FileTooLargeError", "The file exceeds the maximum allowed size.")
            .WithMetadata("StatusCode", 413)
            .WithType(ErrorType.InvalidInput)
            .AsPermanent();

    public static Error NameTooLong() =>
        new Error("Hoster.Pixeldrain.Upload.NameTooLongError", "File name exceeds 255 characters.")
            .WithMetadata("StatusCode", 413)
            .WithType(ErrorType.InvalidInput)
            .AsPermanent();
